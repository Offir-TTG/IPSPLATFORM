-- Add complete Keap integration translations (English and Hebrew)
-- This migration adds all translations for Keap integration pages, navigation, and UI elements

DO $$
DECLARE
  v_tenant_id UUID := '70d86807-7e7c-49cd-8601-98235444e2ac';
BEGIN
  -- Insert or update English and Hebrew translations
  ...
  -- ============================================================================
  -- INTEGRATION CONFIGURATION PAGE TRANSLATIONS
  -- ============================================================================

  -- English Integration Config
  ...
  -- ============================================================================
  -- KEAP DASHBOARD PAGE TRANSLATIONS
  -- ============================================================================
