...
-- This helps calculate correct progress percentages
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'stats', jsonb_build_object(
      ...
      -- NEW: Total lessons across all enrollments
      'total_lessons', (
...
-- Add comment
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard V3 - Added total_lessons to stats for proper progress calculation';
