-- Complete rewrite to eliminate ALL GROUP BY issues
-- Version 3 - Completely isolated subqueries
...
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard aggregation - V3 with completely isolated subqueries to eliminate GROUP BY issues';
