-- ============================================================================
-- Payment System HEBREW Translations - FIXED VERSION
-- ============================================================================
-- This migration adds ONLY the Hebrew translations for the payment system
-- Fixed to properly handle the unique constraint on (tenant_id, language_code, translation_key)
...
BEGIN
  ...
  RAISE NOTICE 'Deleted existing payment translations';

  -- Insert Hebrew translations with proper constraint handling
  ...
  RAISE NOTICE 'Total translations inserted: 181';
