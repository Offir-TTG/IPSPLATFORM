-- ============================================================================
-- Admin Payments Page - Complete Translations
-- ============================================================================
-- Description: Add all English and Hebrew translations for admin payments dashboard
-- Author: System
-- Date: 2025-11-26
...
BEGIN
  ...
  WHERE tenant_id = v_tenant_id
    ...
    AND translation_key NOT LIKE 'admin.payments.plans%'
    AND translation_key NOT LIKE 'admin.payments.schedules%'
    AND translation_key NOT LIKE 'admin.payments.transactions%'
    AND translation_key NOT LIKE 'admin.payments.disputes%';
  ...
  RAISE NOTICE 'Admin payments page translations added successfully';
