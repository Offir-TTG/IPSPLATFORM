-- ALTERNATIVE VERSION: Uses course_id instead of enrollment_id
-- Use this if your user_progress table has course_id but NOT enrollment_id
...
BEGIN
  ...
  -- Build complete dashboard data (using course_id instead of enrollment_id)
...
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard V3 - Uses course_id for progress tracking, handles missing end_time';
