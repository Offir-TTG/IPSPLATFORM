-- Clean slate approach: Drop all dashboard functions and create only V3
-- This ensures we start fresh and avoid any caching issues
...
-- Create ONLY V3 with completely isolated subqueries
...
-- Add comment
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard aggregation V3 - Clean slate with isolated subqueries';

-- Verify creation
SELECT
  'SUCCESS: get_user_dashboard_v3 created!' as status,
  EXISTS(
