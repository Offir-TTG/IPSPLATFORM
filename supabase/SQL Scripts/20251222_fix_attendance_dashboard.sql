-- Fix attendance in dashboard - simplified version
-- This script fixes the ORDER BY issue in the attendance subquery
...
-- Add comment
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard aggregation V3 - With attendance and proper column aliasing';
