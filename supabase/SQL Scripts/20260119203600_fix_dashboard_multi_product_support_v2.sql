...
-- Issue: Enrollments only have product_id (no direct program_id/course_id)
-- Solution: Join through products table to get program/course information
-- V2: Added comprehensive NULL handling and error prevention
  ...
  SELECT jsonb_build_object(
    ...
    'upcoming_sessions', (
      ...
      FROM (
        ...
        -- Join enrollments through products
...
COMMENT ON FUNCTION public.get_user_dashboard_v3 IS 'Get user dashboard data - enrollments only have product_id, join through products table to get program/course info. V2 with comprehensive error handling.';
