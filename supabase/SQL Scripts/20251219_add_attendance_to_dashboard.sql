-- Add attendance records to dashboard function
-- Replace pending_assignments with recent_attendance
...
-- Add comment
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard aggregation V3 - Includes attendance records instead of assignments';
