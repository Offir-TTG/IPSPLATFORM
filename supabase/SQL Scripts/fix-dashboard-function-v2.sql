-- Fix get_user_dashboard function to match actual database schema
-- This version uses the correct column names from the actual tables
...
BEGIN
  ...
  -- Get pending assignments (simplified - just return empty array for now)
  v_pending_assignments := '[]'::jsonb;
