-- Add course_id to upcoming_sessions in dashboard function
-- This allows linking to /courses/[courseId]/lessons/[lessonId]
...
-- Add comment
COMMENT ON FUNCTION public.get_user_dashboard_v3(UUID) IS 'Dashboard aggregation V3 - Includes course_id for session navigation';
