...
// Returns notifications targeted at this user (scope='individual') with
// their read state from notification_reads. Tenant-scoped broadcasts are
// excluded — this view is about messages this person specifically received.
