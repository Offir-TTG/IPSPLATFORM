...
/**
 * GET /api/admin/lms/courses/[id]/attendance
...
export async function GET(
  ...
  try {
    ...
    console.error('Error in GET /api/admin/lms/courses/[id]/attendance:', error);
    return NextResponse.json(
...
/**
 * POST /api/admin/lms/courses/[id]/attendance
...
export async function POST(
  ...
  try {
    ...
    if (upsertError) {
      console.error('❌ Error upserting attendance:', {
        error: upsertError,
    ...
    console.error('Error in POST /api/admin/lms/courses/[id]/attendance:', error);
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    );
