...
// GET /api/admin/lms/courses/[id]/grading/categories - List all categories for a course
export async function GET(
  ...
  try {
    ...
    console.error('Error in GET /api/admin/lms/courses/[id]/grading/categories:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

// POST /api/admin/lms/courses/[id]/grading/categories - Create a new category
export async function POST(
  ...
  try {
    ...
    console.error('Error in POST /api/admin/lms/courses/[id]/grading/categories:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
