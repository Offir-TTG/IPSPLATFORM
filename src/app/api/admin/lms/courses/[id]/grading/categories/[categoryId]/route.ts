...
// PUT /api/admin/lms/courses/[id]/grading/categories/[categoryId] - Update a category
export async function PUT(
  ...
  try {
    ...
    console.error('Error in PUT /api/admin/lms/courses/[id]/grading/categories/[categoryId]:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

// DELETE /api/admin/lms/courses/[id]/grading/categories/[categoryId] - Delete a category
export async function DELETE(
  ...
  try {
    ...
    console.error('Error in DELETE /api/admin/lms/courses/[id]/grading/categories/[categoryId]:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
