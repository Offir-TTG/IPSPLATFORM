...
// GET /api/admin/lms/courses/[courseId]/grading/items - List all grade items for a course
export async function GET(
  ...
  try {
    ...
    console.error('Error in GET /api/admin/lms/courses/[courseId]/grading/items:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

// POST /api/admin/lms/courses/[courseId]/grading/items - Create a new grade item
export async function POST(
  ...
  try {
    ...
    console.error('Error in POST /api/admin/lms/courses/[courseId]/grading/items:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
