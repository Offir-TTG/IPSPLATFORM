...
// POST /api/admin/lms/courses/[courseId]/grading/grades/bulk - Bulk upsert grades
export async function POST(
  ...
  try {
    ...
    console.error('Error in POST /api/admin/lms/courses/[courseId]/grading/grades/bulk:', error);
