...
// PUT /api/admin/lms/courses/[courseId]/grading/items/[itemId] - Update a grade item
export async function PUT(
  request: NextRequest,
  { params }: { params: { courseId: string; itemId: string } }
) {
  try {
    ...
    console.error('Error in PUT /api/admin/lms/courses/[courseId]/grading/items/[itemId]:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

// DELETE /api/admin/lms/courses/[courseId]/grading/items/[itemId] - Delete a grade item
export async function DELETE(
  ...
  try {
    ...
    console.error('Error in DELETE /api/admin/lms/courses/[courseId]/grading/items/[itemId]:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
