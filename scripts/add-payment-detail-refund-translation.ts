/**
 * Add refund display translation for payment details page
 * Run: npx ts-node scripts/add-payment-detail-refund-translation.ts
 */
...
async function addTranslation() {
  try {
    console.log('🌐 Adding refund display translation for payment details page...\n');

    const translations = [
      {
        key: 'user.payments.detail.refunded',
        en: 'Refunded',
        he: 'הוחזר'
      }
    ];
    ...
    console.log('\n✅ Translation added!');
    console.log('\n📝 Updated component: src/app/(user)/payments/[id]/page.tsx');
