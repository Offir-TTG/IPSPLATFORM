...
const translations: TranslationItem[] = [
  // Toast notifications
  { key: 'admin.translations.loadFailed', en: 'Failed to load translations', he: 'נכשל בטעינת תרגומים' },
  { key: 'admin.translations.saveFailed', en: 'Failed to save translation', he: 'נכשל בשמירת תרגום' },
  { key: 'admin.translations.saveSuccess', en: 'Translations saved successfully', he: 'התרגומים נשמרו בהצלחה' },
];
...
async function addTranslations() {
  try {
    console.log('Starting to add toast notification translations...\n');
