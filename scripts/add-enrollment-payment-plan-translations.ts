/**
 * Add missing translation keys for enrollment payment plan display
 * Keys: admin.enrollments.paymentPlan.multiplePlans, admin.enrollments.paymentPlan.defaultPlan
 */
...
const translations: Translation[] = [
  {
    key: 'admin.enrollments.paymentPlan.multiplePlans',
    en: 'Multiple plans available',
    he: 'מספר תוכניות תשלום זמינות',
    context: 'admin'
  },
  {
    key: 'admin.enrollments.paymentPlan.defaultPlan',
    en: 'Default plan',
    he: 'תוכנית ברירת מחדל',
    context: 'admin'
  }
];

async function addTranslations() {
  console.log('Adding enrollment payment plan translations...\n');

  // Get the default tenant ID (assuming single tenant or using first tenant)
  ...
  console.log('✅ All enrollment payment plan translations added successfully!');
}
