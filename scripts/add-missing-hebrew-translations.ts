...
const translations: TranslationItem[] = [
  // Missing admin.translations keys
  { key: 'admin.translations.modules', en: 'Modules', he: 'מודולים' },
  { key: 'admin.translations.allModules', en: 'All Modules (Admin, User, etc.)', he: 'כל המודולים (Admin, User, וכו׳)' },
  { key: 'admin.translations.page', en: 'Page', he: 'עמוד' },
  { key: 'admin.translations.module', en: 'Module', he: 'מודול' },

  // Missing common keys
  { key: 'common.save', en: 'Save', he: 'שמור' },
  { key: 'common.cancel', en: 'Cancel', he: 'ביטול' },
  { key: 'common.edit', en: 'Edit', he: 'ערוך' },
      ...
      if (existingEn) {
        ...
        const { error } = await supabase
          ...
          .insert({
            ...
            context: translation.key.startsWith('admin.') ? 'admin' : 'user',
          });
