/**
 * Add Hebrew translations for invoice refund statuses
 * Run: npx ts-node scripts/add-invoice-refund-translations.ts
 */
...
const translations = [
  {
    key: 'invoices.status.refunded',
    en: 'Refunded',
    he: 'הוחזר'
  },
  {
    key: 'invoices.status.partially_refunded',
    en: 'Partially Refunded',
    he: 'הוחזר חלקית'
  },
  {
    key: 'invoices.refunded_amount',
    en: 'Refunded',
    he: 'הוחזר'
  },
];
...
async function addTranslations() {
  try {
    console.log('🚀 Adding invoice refund translations...\n');
