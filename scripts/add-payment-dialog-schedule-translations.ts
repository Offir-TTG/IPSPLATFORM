/**
 * Add missing translation keys for payment plan dialog schedules
 */
...
const translations: Translation[] = [
  ...
  {
    key: 'admin.enrollments.paymentPlanDetails.currentPlan',
    en: 'Current Plan',
    he: 'התוכנית הנוכחית',
    context: 'admin'
  },
  {
    key: 'admin.enrollments.paymentPlanDetails.paymentSchedules',
    en: 'Payment Schedules',
    he: 'לוחות תשלומים',
    context: 'admin'
  },
  {
    key: 'admin.enrollments.paymentPlanDetails.noSchedule',
    en: 'No schedule',
    he: 'אין לוח תשלומים',
    context: 'admin'
  }
...
async function addTranslations() {
  console.log('Adding payment plan dialog schedule translations...\n');
  ...
  console.log('✅ All payment plan dialog schedule translations added successfully!');
}
