...
async function addAttendanceButtonTranslation() {
  try {
    console.log('🚀 Adding Attendance button translation...\n');
    ...
    const { error: deleteError } = await supabase
      .from('translations')
      .delete()
      .eq('translation_key', 'lms.courses.attendance');
      ...
      .insert([
        {
          tenant_id: tenantId,
          language_code: 'en',
          translation_key: 'lms.courses.attendance',
    ...
    console.log('✅ Added Attendance button translation');
...
addAttendanceButtonTranslation();
