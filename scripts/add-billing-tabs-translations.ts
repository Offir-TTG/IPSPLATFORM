...
const translations = [
  // Billing tabs
  { key: 'user.profile.billing.enrollmentsTab', en: 'Enrollments', he: 'הרשמות' },
  { key: 'user.profile.billing.invoicesTab', en: 'Stripe Invoices', he: 'חשבוניות Stripe' },
];
...
async function addTranslations() {
  try {
    ...
    console.log(`\n📝 Adding/updating ${translations.length * 2} billing tabs translations for tenant: ${tenantId}\n`);
