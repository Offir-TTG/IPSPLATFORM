...
const translations = [
  // User segments
  { key: 'admin.payments.reports.segments.instructors', en: 'Instructors', he: 'מדריכים' },
  { key: 'admin.payments.reports.segments.staff', en: 'Staff', he: 'צוות' },
];
...
async function addTranslations() {
  try {
    ...
    console.log(`\n📝 Adding/updating ${translations.length * 2} segment translations for tenant: ${tenantId}\n`);
