...
async function addViewGradesTranslation() {
  try {
    console.log('🚀 Adding view grades translation...\n');
    ...
    const { error: deleteError } = await supabase
      .from('translations')
      .delete()
      .eq('translation_key', 'user.courses.actions.viewGrades');
      ...
      .insert([
        {
          tenant_id: tenantId,
          language_code: 'en',
          translation_key: 'user.courses.actions.viewGrades',
          translation_value: 'View Grades',
          context: 'user',
    ...
    console.log('✅ Added view grades translation');
