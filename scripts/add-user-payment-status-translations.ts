/**
 * Add Hebrew translations for user payment status (refunded)
 * Run: npx ts-node scripts/add-user-payment-status-translations.ts
 */
...
const translations = [
  // User payments page
  {
    key: 'user.payments.statusRefunded',
    en: 'Refunded',
    he: 'הוחזר'
  },
  {
    key: 'user.payments.statusPartiallyRefunded',
    en: 'Partially Refunded',
    he: 'הוחזר חלקית'
  },
  // User payment details page
  {
    key: 'user.payments.status.refunded',
    en: 'Refunded',
    he: 'הוחזר'
  },
  {
    key: 'user.payments.status.partially_refunded',
    en: 'Partially Refunded',
    he: 'הוחזר חלקית'
  },
];
...
async function addTranslations() {
  try {
    console.log('🚀 Adding user payment status translations...\n');
