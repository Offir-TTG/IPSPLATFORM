/**
 * Add Password Reset Email Template Translations
 * Adds translations for the password reset email template metadata
 *
 * Usage: npx tsx scripts/add-password-reset-template-translations.ts
 */
...
const translations = [
  ...
  {
    key: 'email_template.system_password_reset.name',
    en: 'Password Reset',
    he: 'איפוס סיסמה'
  },
  // Template description translations
  {
    key: 'email_template.system_password_reset.description',
    en: 'Sent when admin triggers password reset for a user',
    he: 'נשלח כאשר מנהל מפעיל איפוס סיסמה עבור משתמש'
  },
];

async function addTranslations() {
  console.log('🌍 Adding password reset email template translations...\n');
