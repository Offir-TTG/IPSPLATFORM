/**
 * Add translation for "Loading your invitation..." message
 */
...
async function addTranslation() {
  console.log('Adding loading invitation translation...\n');
  ...
  const key = 'enrollment.loading';
  const en = 'Loading your invitation...';
  const he = 'טוען את ההזמנה שלך...';
