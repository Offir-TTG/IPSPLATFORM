...
const translations = [
  // Meeting not started error message
  {
    key: 'user.courses.meetingNotStarted',
    en: 'This meeting has not started yet. Please wait for the host to start the meeting.',
    he: 'הפגישה עדיין לא התחילה. אנא המתן למארח להתחיל את הפגישה.'
  },
];
