/**
 * Add translation for payment plan details loading text
 */
...
const translations: Translation[] = [
  {
    key: 'admin.enrollments.paymentPlanDetails.loading',
    en: 'Loading payment plan details...',
    he: 'טוען פרטי תוכנית תשלום...',
    context: 'admin'
  }
];

async function addTranslations() {
  console.log('Adding payment plan loading translation...\n');
  ...
  console.log('✅ Payment plan loading translation added successfully!');
}
