...
async function addMonthlyPaymentTranslation() {
  const translations = [
    {
  ...
  console.log('Adding monthly payment translation...');
  ...
  console.log('\n✨ Monthly payment translation added successfully!');
}

addMonthlyPaymentTranslation()
  .then(() => process.exit(0))
  .catch((error) => {
