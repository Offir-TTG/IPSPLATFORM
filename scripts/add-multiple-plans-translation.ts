/**
 * Add translation for "Multiple payment plans available" in enrollment preview
 */
...
async function addTranslation() {
  console.log('Adding multiple payment plans translation...\n');
  ...
  const key = 'enrollment.paymentPlan.multiplePlans';
  const en = 'Multiple payment plans available';
  const he = 'תוכניות תשלום מרובות זמינות';
