...
const translations = [
  // Product Types
  { key: 'product.type.program', en: 'Program', he: 'תוכנית' },
  { key: 'product.type.course', en: 'Course', he: 'קורס' },

  // Payment Plan Types
  { key: 'payment.plan.type.full_payment', en: 'Full Payment', he: 'תשלום מלא' },
  { key: 'payment.plan.type.deposit', en: 'Deposit + Installments', he: 'מקדמה + תשלומים' },
  { key: 'payment.plan.type.installments', en: 'Installments', he: 'תשלומים' },
  { key: 'payment.plan.type.subscription', en: 'Subscription', he: 'מנוי' },
  { key: 'payment.plan.type.free', en: 'Free', he: 'חינם' },
];
