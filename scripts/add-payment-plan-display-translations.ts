...
const translations = [
  ...
  { key: 'user.profile.billing.oneTimePayment', en: 'One-Time Payment', he: 'תשלום חד-פעמי' },
  { key: 'user.profile.billing.depositPlusInstallments', en: 'Deposit + Installments', he: 'מקדמה + תשלומים' },
  { key: 'user.profile.billing.subscription', en: 'Subscription', he: 'מנוי' },
  { key: 'user.profile.billing.free', en: 'Free', he: 'חינם' },
];
...
async function addTranslations() {
  try {
    ...
    console.log(`\n📝 Adding/updating ${translations.length * 2} payment plan display translations for tenant: ${tenantId}\n`);
