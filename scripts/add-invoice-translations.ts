/**
 * Add Hebrew translations for invoice-related text
 * Run: npx ts-node scripts/add-invoice-translations.ts
 */
...
const translations = [
  {
    key: 'invoices.paymentNumber',
    en: 'Payment #',
    he: 'תשלום מס\' '
  },
  {
    key: 'invoices.paymentFor',
    en: 'Payment for',
    he: 'תשלום עבור'
  },
  {
    key: 'invoices.defaultDescription',
    en: 'Invoice',
    he: 'חשבונית'
  },
  {
    key: 'invoices.stripeInvoices',
    en: 'Stripe Invoices',
    he: 'חשבוניות סטרייפ'
  }
];
