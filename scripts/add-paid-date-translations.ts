...
const translations: TranslationItem[] = [
  { key: 'admin.payments.schedules.paidDate', en: 'Paid Date', he: 'תאריך תשלום' },
  { key: 'admin.payments.schedules.latePaid', en: 'Late', he: 'באיחור' },
  { key: 'admin.payments.schedules.earlyPaid', en: 'Early', he: 'מוקדם' },
  { key: 'admin.payments.schedules.onTime', en: 'On Time', he: 'בזמן' },
  { key: 'common.days', en: 'd', he: 'י' },
];
...
async function addTranslations() {
  try {
    console.log('Starting to add paid date translations...\n');
